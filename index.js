...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, audioRemind, sun, sunDuration, roosterContext, roosterTimers, newAudio, soundToggle, show, adjust, toggle, reset, blink, count, run, resize, updateSunPosition, triggerRoosterCrow, stopRoosterCrow;
start = null;
isBlink = false;
isLight = true;
isRun = false;
...
updateSunPosition = function(remaining){
  ...
  return sun.style.bottom = target + "vh";
};
